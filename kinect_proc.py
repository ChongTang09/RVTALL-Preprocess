...
if __name__ == '__main__':
    ...
    bvh_processer = BVHReader(save_folder=r'D:\Glasgow\RVTALL\datacollection\1022_liyuan_qi\QLY\sentences10\landmarkers') # the final folder must be named as 'landmarkers'
    bvh_processer.proc_folder(tgt_folder=r'D:\Glasgow\RVTALL\datacollection\1022_liyuan_qi\QLY\sentences10\kinect_bvh') # this folder is 'kinect_bvh' folder in the raw collection
    
    # Step 2: process 3D position data, video and audio
    kinect = KinectProcessor(root_dir=r'D:\Glasgow\RVTALL\datacollection\1022_liyuan_qi\QLY\sentences10', save_dir=r'D:\Glasgow\RVTALL\datacollection\1022_liyuan_qi\QLY\sentences10\processed')
